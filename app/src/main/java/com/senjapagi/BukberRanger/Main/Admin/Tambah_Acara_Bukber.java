...
//        ktg.setAdapter(adapter);
    ...
    private void checkData(){
        boolean isSafetoUpload=true;
        if(tanggal.getText().toString().equals("")){
            isSafetoUpload=false;
        }
        if(kuotaIkhwan.getText().toString().equals("")){
            isSafetoUpload=false;
        }
        if (kuotaIkhwan.getText().toString().equals("")){
            isSafetoUpload=false;
        }
        if(kuotaAkhwat.getText().toString().equals("")){
            isSafetoUpload=false;
        }
        if (catatan.getText().toString().equals("")){
            isSafetoUpload=false;
        }
        if (lauk.getText().toString().equals("")){
            isSafetoUpload=false;
        }
        if (isSafetoUpload){
            uploadData();
        }else{
            makeToast("Periksa Inputan Anda Terlebih Dahulu");
        }
    }
